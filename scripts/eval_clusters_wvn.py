    ...
    if cfg.save_plots and cfg.save_comparison_plots:
        for metric in ["Avg_clusters", "Feature_var", "Code_var", "Time"]:
            ...
            if cfg.cluster_stego_by_image:
                ...
                plot_distributions(metric_stego_cluster_values, 100, metric_stego_cluster_names, metric, os.path.join(plot_dir, "Comparison_"+metric+"_STEGO_code_"+str(time_now)+".png"))
            
            plot_distributions(metric_stego_values+metric_slic_values+metric_stego_cluster_values, 100, metric_stego_names+metric_slic_names+metric_stego_cluster_names, metric, os.path.join(plot_dir, "Comparison_"+metric+"_all_"+str(time_now)+".png"))
